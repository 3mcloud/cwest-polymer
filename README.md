...
Polymer analysis was done on theoretical data, which was imported from .csv files. The figures were then generated by 
applying data transformation pipelines described below:
...
[An example of generated interactive plots can be downloaded here](Results/fmr_graph_spectrum.html)
<p float="justify">
    <img align="top" src="/Results/fmr_graph_spectrum.png", height=300 />
</p>
...
Column headers are read using `cwest_polymer.fmr_filereaders.fmr_mass_spreadsheet_reader.MassSpreadsheetReader` class. Custom column fields can be used to modify the reader and an example of such is shown [here](Example) 
```
...
<a href="Results/fmr_graph_spectrum.html" download>Download example of generated interactive plots</a>
```
# imports
